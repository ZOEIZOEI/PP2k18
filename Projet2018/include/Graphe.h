...
class Graphe
{
    public:
         ...
         *
         * \param nom_fichier std::string : image associ�e au sommet a recuperer
         * \return void
         *
         */
        ...
        /** \brief Renvoi un graphe transpos� pour la forte connexite
         *
         * \return Graphe
         *
         */
         ...
         *
         * \param connexe std::vector<std::vector<int> > : Matrice de forte connexit�
         * \return void
         *
         */
    ...
    private:
        ...
        std::vector<Sommet*> m_s_sup; /**< Vecteur de sommets pouvant etre ajout�s au graphe (ayant ete supprimes) */
        ...
        int m_nb_s_sup; /**< Ordre des sommets supprim�s */
        bool m_play; /**< Lance la dynamique en temps r�el */
        bool m_reduit; /**< Indique s'il faut afficher le graphe r�duit */
